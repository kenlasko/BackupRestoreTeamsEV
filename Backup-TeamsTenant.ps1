...
# Update Manifest to include Ken Lasko as author!
# update connection method to Connect-SkypeOnline
# add connection to Microsoft Teams

<#
	.SYNOPSIS
		A script to automatically backup a Microsoft Teams configuration.
...
$BackupFile = ('TeamsBackup_' + (Get-Date -Format yyyy-MM-dd) + '.zip')
